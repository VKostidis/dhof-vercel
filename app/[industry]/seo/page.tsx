...
export async function generateMetadata({
  ...
  if (!d) return { title: "SEO | Digital Hall of Fame" };
  return {
    title: d.seo.meta.title,
    description: d.seo.meta.description,
    alternates: { canonical: `${BASE}/${industry}/seo/` },
  };
}
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b-2 border-ink">
                  ...
                  <th className="text-left py-3 pr-6 font-bold text-ink/50 text-[13px] w-[41%]">Typical agency</th>
      ...
      {s.proofTitle && (
        <section className="bg-paper py-20 md:py-24">
          <div className="max-w-[1240px] mx-auto px-[clamp(24px,5vw,100px)]">
            ...
            {s.proofBody && (
              <p className="text-[15px] text-ink/65 leading-relaxed max-w-[65ch] mb-6 whitespace-pre-line">{s.proofBody}</p>
            )}
